...
urlpatterns = [
    ...
    url(r'^taxi_emergency_location/(?P<pk>[\w|\W]+)/$', views.taxi_emergency_location, name='taxi_emergency_location'),
    url(r'^update_location/', views.update_location, name='update_location'),
    url(r'^get_taxi_location/(?P<pk>[\w|\W]+)/$', views.get_taxi_location, name='get_taxi_location'),
